...
public class UpdateCarCommand implements Command {
    ...
    private UpdateCarCommand(Service<Car, CreateCarRequest, UpdateCarRequest> carService, Scanner scanner) {
        this.carService = carService;
        this.scanner = scanner;
    }

    public static synchronized UpdateCarCommand getInstance(Service<Car, CreateCarRequest, UpdateCarRequest> carService, Scanner scanner) {
        if (instance == null) {
